#!/usr/bin/env bash
#SBATCH --job-name=amazontitles131k_tfidf
...
readonly DATA_ROOT="/nfs-stor/linh.vu/LF-AmazonTitle-131K-ZS/LF-AmazonTitles-131K/zeroshot"
readonly DATASET_NAME="LF-AmazonTitles-131K"
readonly RUN_NAME="amazontitles131k_zs_tfidf_raw"
