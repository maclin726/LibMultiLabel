...
train_instance_data_path="$data_root/MIMIC_tfidf_train_ext.svm"
test_instance_data_path="$data_root/MIMIC_tfidf_test_ext.svm"
label_feature_path="$data_root/MIMIC_tfidf_lf.svm"
